...
public class mark extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonHover1.setColorTextHover(new java.awt.Color(255, 0, 0));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Topic", "Marks Obtained", "Total Marks"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, 770, 380));
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        ...
        if(jComboBox2.getSelectedIndex()!=0){
            ...
            try {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3308/fsms");
                java.sql.Statement st=con.createStatement();
                String sql="SELECT m.* FROM marks m join enrollment e on(e.enrollmentID=m.enrollmentID) join course c on (c.courseID=e.courseID) where e.stdID="+Login.roll+" and c.courseName='"+cor+"'";
                java.sql.ResultSet rs= st.executeQuery(sql);
                while(rs.next()){
